package by.bundesliga.fan.dao.impl.connection;
...
public class ConnectionPool {
    ...
    private ConnectionPool() {
        this.driverName = ConnectionParameters.DB_DRIVER;
        this.url = ConnectionParameters.DB_URL;
        this.user = ConnectionParameters.DB_USER;
        this.password = ConnectionParameters.DB_PASSWORD;

        try {
            this.poolSize = Integer.parseInt(ConnectionParameters.DB_POOL_SIZE);
